...
def setup_test_loader(test_data, params):
    ...
    for (x_test, y_test) in test_data:
        ...
        test_loader = data.DataLoader(test_dataset, batch_size=len(x_test), shuffle=False, num_workers=0, pin_memory=True)
